...
// -----------------------------------------------------------------------------
chrome.storage.sync.get(["quality","translate","type"], filterGet);
// -----------------------------------------------------------------------------
...
// -----------------------------------------------------------------------------
chrome.tabs.query({active: true}, get);
// -----------------------------------------------------------------------------
        ...
        if (online.readyState == 4) {
            ...
            if (onlineXml && onlineXml.length >= 1) {
                ...
                for (var i = 0; i < onlineXml.length; i++) {
                    ...
                    onlineDataA.setAttribute("href", "/html/online.html#" + onlineXml[i].getAttribute("href") + "///" + encodeURIComponent(tabs[0].title) + "///online");
...
// ONLINE **********
                    ...
                    torrentOnline.setAttribute("href", "/html/online.html#http://torrent.qimdb.com/download/" + torrentXml[i].getAttribute("tracker") + "_" + torrentXml[i].getAttribute("tracker_id") + "///" + encodeURIComponent(tabs[0].title) + "///acestream");
...
function version() {
    ...
    version.onreadystatechange = function() {
        ...
        if (version.readyState == 4) {
            ...
            if ('' + version.responseText != chrome.app.getDetails().version + '') {
                ...
                verA.setAttribute("href", "/html/iframe.html#http://filmego.org/update");
